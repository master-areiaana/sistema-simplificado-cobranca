  ...
  return (
    <div style={{ fontFamily: "'Segoe UI',system-ui,sans-serif", background: t.bg, minHeight: "100vh", color: t.txt }}>
      ...
      <main style={{ padding: "14px 16px", maxWidth: "100%", margin: "0 auto" }}>
        ...
        {/* TABS */}
        <div style={{ display: "flex", gap: 6, marginBottom: 14, overflowX: "auto", paddingBottom: 6, paddingTop: 4, scrollbarWidth: "thin", WebkitOverflowScrolling: "touch", alignItems: "center", justifyContent: "center" }}>
