  ...
  return (
    <div style={{ fontFamily: "'Segoe UI',system-ui,sans-serif", background: t.bg, minHeight: "100vh", color: t.txt }}>
      ...
      <main style={{ padding: "14px 16px", maxWidth: "100%", margin: "0 auto" }}>
        ...
        {activeTab === "carteira" && (
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 10, marginBottom: 14, maxWidth: "1200px", margin: "0 auto 14px" }}>
            {kpiFilter && (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {/* KPIs Produtividade */}
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 10, maxWidth: "1200px", margin: "0 auto" }}>
